...
public class UnpublishSongCommandHandlerTests : TestBase
{
    ...
    public async Task Handle_ShouldUnpublishSong_WhenValid()
    {
        ...
        publishedSong.IsPublished.Should().BeFalse();
    }
    ...
    {   
        // Arrange
        var command = new UnpublishSongCommand(Guid.NewGuid(), Guid.NewGuid());
    ...
    public async Task Handle_ShouldReturnFailure_WhenModeratorIsNotActive()
    {
        ...
        var command = new UnpublishSongCommand(moderator.Id, Guid.NewGuid());
    ...
    [Fact]
    public async Task Handle_ShouldReturnFailure_WhenSongIsAlreadyUnpublished()
    {
        // Arrange
        var moderator = Moderator.Create(
            new Email("moderator@example.com"),
