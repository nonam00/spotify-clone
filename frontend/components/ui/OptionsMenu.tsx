...
const OptionsMenu = ({
  ...
  return (
    <div className={twMerge("relative inline-block text-left", className)} ref={menuRef}>
      <button
        type="button"
        aria-haspopup="menu"
      ...
      >
        {triggerContent ?? <HiDotsVertical size={iconSize} className="text-neutral-400 group-focus:text-neutral-200" />}
      </button>
